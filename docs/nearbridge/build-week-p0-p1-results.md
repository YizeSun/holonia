...
按 [`../build-week/reviewer-runbook.md`](../build-week/reviewer-runbook.md) 从带物理验证记录的 P0/P1 tag 构建两端，录制一次干净的 reviewer walkthrough，并保存能清楚显示两端 execution receipt 的视频帧。延期稳定性与多设备测试继续留在 TODO，不阻塞当前提交。
